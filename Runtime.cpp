...
short WINAPI DLLExport CreateRunObject(LPRDATA rdPtr, LPEDATA edPtr, fpcob cobPtr)
{
	...
	*/
	...
	rdPtr->UIndex = new vector<string>;
	rdPtr->UVars = new vector<UInt64>;
	rdPtr->SIndex = new vector<string>;
	rdPtr->SVars = new vector<SInt64>;
...
*/
	...
	if(rdPtr->UIndex != NULL) delete rdPtr->UIndex;
	rdPtr->UIndex = NULL;

	if(rdPtr->UVars != NULL) delete rdPtr->UVars;
	rdPtr->UVars = NULL;

	if(rdPtr->SIndex != NULL) delete rdPtr->SIndex;
	rdPtr->SIndex = NULL;

	if(rdPtr->SVars != NULL) delete rdPtr->SVars;
	rdPtr->SVars = NULL;
